...
# AuraRPC Documentation

Technical reference for AuraRPC v1.0. Documentation is maintained in English
only; the user-facing README is available in English and Spanish.
...
| [SECURITY.md](SECURITY.md) | Threat model, privacy guarantees, and vulnerability reporting. |